#brigitte
> Hackathon Product Hunt.

[![Build Status](https://travis-ci.org/mounibec/brigitte.svg?branch=master)](https://travis-ci.org/mounibec/brigitte) [![Dependency Status](https://david-dm.org/mounibec/brigitte.svg)](https://david-dm.org/mounibec/brigitte) [![devDependency Status](https://david-dm.org/mounibec/brigitte/dev-status.svg)](https://david-dm.org/mounibec/brigitte#info=devDependencies)
...
## Release History
 * 2014-10-25   v0.1.0   Generated by the [Yeoman Generator](https://github.com/FamousTools/generator-famous) for [Famo.us](http://famo.us)